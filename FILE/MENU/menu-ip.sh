...
APIGIT=$(cat /etc/rizyulstore/github/api)
EMAILGIT=$(cat /etc/rizyulstore/github/email)
USERGIT=$(cat /etc/rizyulstore/github/username)
...
if [[ -f /etc/rizyulstore/github/api && -f /etc/rizyulstore/github/email && /etc/rizyulstore/github/username ]]; then
   rec="OK"
else
    mkdir /etc/rizyulstore/github > /dev/null 2>&1
fi
...
sleep 2
echo "$EMAIL1" > /etc/rizyulstore/github/email
echo "$USERNAME1" > /etc/rizyulstore/github/username
echo "$API1" > /etc/rizyulstore/github/api
echo "ON" > /etc/rizyulstore/github/gitstat
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
function resetipvps(){
clear
rm -f /etc/rizyulstore/github/email
rm -f /etc/rizyulstore/github/username
rm -f /etc/rizyulstore/github/api
rm -f /etc/rizyulstore/github/gitstat
echo "OFF" > /etc/rizyulstore/github/gitstat
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
...
echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
GITREQ=/etc/rizyulstore/github/gitstat
if [ -f "$GITREQ" ]; then
    cekk="ok"
else 
    mkdir /etc/rizyulstore/github
    touch /etc/rizyulstore/github/gitstat
    echo "OFF" > /etc/rizyulstore/github/gitstat
fi

stst1=$(cat /etc/rizyulstore/github/gitstat)
if [ "$stst1" = "OFF" ]; then
clear
echo -e "$COLOR1┌─────────────────────────────────────────────────┐${NC}"
echo -e "$COLOR1 ${NC} ${COLBG1}               ${WH}• REGISTER IPVPS •              ${NC} $COLOR1 $NC"
...
stst=$(cat /etc/rizyulstore/github/gitstat)
if [ "$stst" = "ON" ]; then
APIOK="CEK API"
rex="viewapi"
else
