...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/dendikusnandi/iLoveU/FILE/main/ipvps | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/dendi.kusnandi.official"
echo -e "${NC}${LIGHT}WhatsApp : 082117696800"
echo -e "${NC}${LIGHT}Telegram : https://t.me/dendikusnandi"
exit 0
fi
clear
